...
public class ShopAllDeals extends Utility {
    ...
    public void clickOnShopAllDeals() {
        Reporter.log("Click on Shop All Deals : " + _shopAllDeals.toString() + "<br>");
        log.info("Click on Shop All Deals : " + _shopAllDeals.toString());
        clickOnElement(_shopAllDeals);
    }

    public String getTextFromShopDeals() {
        Reporter.log("Get Text from Shop Deals : " + _getTextShopDeals.toString() + "<br>");
    ...
    public void selectDiscountHighToLow() {
        Reporter.log("Select Discount High to Low from Drop Down : " + _selectDiscountHighToLow.toString() + "<>br");
    ...
    public void getListOfHighestDiscountedProducts() {
        Reporter.log("Get list of highest discounted products : " + _listOfHighestDiscountedProducts.toString() + "<br>");
