...
public class LastMinuteDealPage extends Utility {
    ...
    public void clickOnComputersAndSoftware() {
        Reporter.addStepLog("Click on Computer And Software : " +  _computersAndSoftware.toString()+ "<br>");
    ...
    public boolean isLastMinuteDealPageDisplayed(){
        Reporter.addStepLog("Get Text from Last Minute Deals Page : " +_getTextLastMinute.toString() + "<br>");
