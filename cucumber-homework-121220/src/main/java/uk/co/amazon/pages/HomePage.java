...
public class HomePage extends Utility {
    ...
    public void clickOnLastMinuteDeals() {
        Reporter.addStepLog("Click on Last Minute Deals : " + _lastMinuteDeals.toString() + "<br>");
    ...
    public void mouseHoverOnHelloSignIn() {
        Reporter.addStepLog("Mouse hover on Hello Sign In : " + _helloSignIn.toString() + "<br>");
    ...
    public void clickOnStartHereForNewCustomer() {
        Reporter.addStepLog("Click on new customer start here : " + _newCustomerStartHere.toString() + "<br>");
